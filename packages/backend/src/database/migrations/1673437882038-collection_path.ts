...
export class collectionPath1673437882038 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD "name" character varying(32)`);
        ...
        await queryRunner.query(`ALTER TABLE "nft_in_drop" ADD CONSTRAINT "FK_61a54557c0f248eece974eeb2eb" FOREIGN KEY ("nft_id") REFERENCES "nft"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
